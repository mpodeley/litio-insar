...
Trae los polígonos de piletas de evaporación / cuerpos de agua / uso industrial
dentro del bounding box de aoi.py y los guarda como overlay.geojson, que los
visuales (04_export_visual.py, 05_timeseries_slider.py, heatmap_subsidencia.py)
dibujan como contorno sobre los mapas.

    python overlay_osm.py            # escribe overlay.geojson

Es un PUNTO DE PARTIDA: la cobertura de OSM en la Puna es parcial. Revisá el
